...
@section('title','Asal Perolehan Alat Peraga')
...
@section('content')
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <form method="post" action="">
                        <a href="{{ url('data_peraga') }}"><i class="fas fa-chevron-circle-left mt-2 mr-3"></i></a></i>Daftar Asal Perolehan Alat Peraga
                        @csrf
    ...
    <script>
      ...
      $(document).on('click', '#hpssumberper', function(e){
              ...
              Swal.fire({
                  title: 'Yakin Dihapus?',
                  text: "Jika asal dihapus, maka peraga dengan asal ini ikut terhapus!",
                  icon: 'warning',
